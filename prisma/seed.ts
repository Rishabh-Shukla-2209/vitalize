...
async function seed() {
  ...
  await prisma.notification.createMany({
    data: [
      // --- Shreya's Post ---
      {
        recipientid: shreya.id,
        actorId: riya.id,
        type: NotificationType.LIKE,
        target: NotificationTargetType.LIKE_POST,
        targetId: postShreya1.id,
        payload: { message: "Riya liked your post" },
      },
      {
        recipientid: shreya.id,
        actorId: aarav.id,
        ...
        target: NotificationTargetType.LIKE_POST,
        targetId: postShreya1.id,
        payload: { message: "Aarav liked your post" },
      },
      {
        recipientid: shreya.id,
        actorId: riya.id,
        type: NotificationType.COMMENT,
        target: NotificationTargetType.COMMENT,
        targetId: postShreya1.id,
        payload: {
          message: "Riya commented: Amazing effort, Shreya! Keep it up! 🙌",
        },
      },
      {
        recipientid: shreya.id,
        ...
        target: NotificationTargetType.COMMENT,
        targetId: postShreya1.id,
        payload: { message: "Aarav commented: Nice progress 💪" },
      },
      ...
      // --- Zoya's Post ---
      {
        ...
        target: NotificationTargetType.LIKE_POST,
        targetId: postZoya1.id,
        payload: { message: "Ananya liked your post" },
      },
      {
        recipientid: zoya.id,
        actorId: ishan.id,
        ...
        target: NotificationTargetType.LIKE_POST,
        targetId: postZoya1.id,
        payload: { message: "Ishan liked your post" },
      },
      {
        recipientid: zoya.id,
        actorId: ananya.id,
        ...
        targetId: postZoya1.id,
        payload: {
          message: "Ananya commented: Well done Zoya! Keep pushing! 🚀",
        },
      },
      {
        recipientid: zoya.id,
        ...
        target: NotificationTargetType.COMMENT,
        targetId: postZoya1.id,
        payload: { message: "Ishan commented: Impressive run! 👏" },
      },

      // --- Aadya's Post ---
      {
        recipientid: aadya.id,
        actorId: zoya.id,
        type: NotificationType.LIKE,
        target: NotificationTargetType.LIKE_POST,
        targetId: postAadya1.id,
        payload: { message: "Zoya liked your post" },
      },
      {
        recipientid: aadya.id,
        actorId: riya.id,
      ...
      },
      {
        ...
        target: NotificationTargetType.COMMENT,
        targetId: postAadya1.id,
        payload: { message: "Zoya commented: Crushing that core! 🔥" },
      },
      {
        recipientid: aadya.id,
        actorId: riya.id,
        ...
        target: NotificationTargetType.COMMENT,
        targetId: postAadya1.id,
        payload: { message: "Riya commented: Inspiring!" },
      },

      // --- Rishabh's Post ---
      {
        recipientid: rishabh.id,
        actorId: shreya.id,
        type: NotificationType.LIKE,
        target: NotificationTargetType.LIKE_POST,
        targetId: postRishabh1.id,
        payload: { message: "Shreya liked your post" },
      },
      {
        recipientid: rishabh.id,
        actorId: zoya.id,
      ...
      },
      {
        ...
        target: NotificationTargetType.COMMENT,
        targetId: postRishabh1.id,
        payload: { message: "Zoya commented: Insane session, respect! 😲" },
      },
      {
        recipientid: rishabh.id,
        actorId: shreya.id,
        ...
        target: NotificationTargetType.COMMENT,
        targetId: postRishabh1.id,
        payload: { message: "Shreya commented: Absolute beast mode 💪" },
      },
      ...
      // --- Follow Notifications ---
      {
        ...
        target: NotificationTargetType.FOLLOW,
        targetId: vihaan.id,
        payload: { message: "Vihaan started following you" },
      },
      {
        recipientid: shreya.id,
        actorId: aarav.id,
        ...
        target: NotificationTargetType.FOLLOW,
        targetId: aarav.id,
        payload: { message: "Aarav started following you" },
      },
      {
        recipientid: riya.id,
        actorId: arjun.id,
        ...
        target: NotificationTargetType.FOLLOW,
        targetId: arjun.id,
        payload: { message: "Arjun started following you" },
      },
      {
        recipientid: vihaan.id,
        actorId: devansh.id,
        type: NotificationType.FOLLOW,
        target: NotificationTargetType.FOLLOW,
        targetId: devansh.id,
        payload: { message: "Devansh started following you" },
      },

      // --- Remaining posts and interactions ---
      {
        ...
        target: NotificationTargetType.LIKE_POST,
        targetId: postAarav1.id,
        payload: { message: "Rishabh liked your post" },
      },
      {
        recipientid: aarav.id,
        actorId: vihaan.id,
        ...
        target: NotificationTargetType.COMMENT,
        targetId: postAarav1.id,
        payload: { message: "Vihaan commented: Squats on point!" },
      },
      {
        recipientid: riya.id,
        actorId: ananya.id,
      ...
      },
      {
        ...
        target: NotificationTargetType.COMMENT,
        targetId: postRiya1.id,
        payload: { message: "Shreya commented: Great pace!" },
      },
      {
      ...
      },
      {
        ...
        target: NotificationTargetType.COMMENT,
        targetId: postAnanya1.id,
        payload: { message: "Vihaan commented: Stretching is life! 💯" },
      },
      {
        recipientid: vihaan.id,
        actorId: devansh.id,
        ...
        target: NotificationTargetType.LIKE_POST,
        targetId: postVihaan1.id,
        payload: { message: "Devansh liked your post" },
      },
      {
        recipientid: reyansh.id,
        actorId: arjun.id,
        type: NotificationType.COMMENT,
        target: NotificationTargetType.COMMENT,
        targetId: postReyansh1.id,
        payload: { message: "Arjun commented: Strong session! 💪" },
      },
      {
        recipientid: ishan.id,
        actorId: reyansh.id,
        type: NotificationType.LIKE,
        target: NotificationTargetType.LIKE_POST,
        targetId: postIshan1.id,
        payload: { message: "Reyansh liked your post" },
      },
      {
        recipientid: devansh.id,
        actorId: shreya.id,
        type: NotificationType.COMMENT,
        target: NotificationTargetType.COMMENT,
        targetId: postDevansh1.id,
        payload: { message: "Shreya commented: Great combo session! 💪" },
      },
      {
